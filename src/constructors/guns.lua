...
function cons_proj(n, spread, speed, anim)
    return function(e)
        ...
        for i = 1, n do
            ...
            p:add(anim)
            p:add(rb:new(0, 0))
            p:add(col:new(v2:new(2, 2), v2:new(6, 6), false, false, m_world | m_enemy, m_projectile))
...
function cons_grenade(e)
    local ps = cons_proj(1, 0, 100, anim:new{35, 36})(e)
...
function cons_rocket(e)
    local rs = cons_proj(1, 0, 80, anim:new{14, 30})(e)
...
function cons_throw(anim, on_land, from)
    ...
    e:add(col:new(v2:new(), v2:new(8, 8), false, false, world))
    e:add(rb:new())
